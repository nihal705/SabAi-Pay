...
const availableMerchants = [
  {
    ...
    name: "SabAI Pay Lite",
    category: "universal",
    logoUrl: "/images/merchants/sabailogo.png",
  },
  {
    id: "swiggy",
    name: "Swiggy",
    category: "food",
    logoUrl: "/images/merchants/swiggy.png",
  },
  {
    id: "zomato",
    name: "Zomato",
    category: "food",
    logoUrl: "/images/merchants/zomato.png",
  },
  {
    id: "zepto",
    name: "Zepto",
    category: "groceries",
    logoUrl: "/images/merchants/zepto.png",
  },
  {
    id: "blinkit",
    name: "Blinkit",
    category: "groceries",
    logoUrl: "/images/merchants/blinkit.png",
  },
  {
    id: "amazon",
    name: "Amazon",
    category: "shopping",
    logoUrl: "/images/merchants/amazon.png",
  },
  {
    id: "flipkart",
    name: "Flipkart",
    category: "shopping",
    logoUrl: "/images/merchants/flipkart.png",
  },
  {
    id: "myntra",
    name: "Myntra",
    category: "shopping",
    logoUrl: "/images/merchants/myntra.png",
  },
  {
    id: "netmeds",
    name: "NetMeds",
    category: "healthcare",
    logoUrl: "/images/merchants/netmeds.png",
  },
  {
    id: "pharmeasy",
    name: "PharmEasy",
    category: "healthcare",
    logoUrl: "/images/merchants/pharmeasy.png",
  },
];
...
const PopUpiLimitAddedModal = ({ transactionData, onClose }) => {
  ...
  const formattedAvailableLimit = transactionData?.availableLimit
    ? Number(transactionData.availableLimit).toLocaleString("en-IN", {
          ...
          {showDetails && (
            ...
            >
              ...
              <div className="detail-item">
                ...
                <span>
                  {orderData?.bankName} (xxxx{orderData?.bankAccountLast4})
                </span>
              </div>
              <div className="detail-item highlight">
                <span>Next Payment</span>
                <span>
                  {new Date(orderData?.nextExecution).toLocaleString()}
                </span>
              </div>
              <div className="detail-item">
          ...
          {showDetails && (
            ...
            >
              <div className="detail-item">
                ...
                <span>
                  {transactionData?.banks?.length || 1} bank account(s)
                </span>
              </div>
              ...
              <div className="detail-item highlight">
                ...
                <span>
                  ₹{transactionData?.remainingLimit?.toLocaleString()}
                </span>
              </div>
              <div className="detail-item">
                <span>Date & Time</span>
      ...
      >
        ...
        <div className="delete-order-details">
          ...
          <div className="detail-row">
            <span>Bank:</span>
            <span>
              {order?.bankName} (xxxx{order?.bankAccountLast4})
            </span>
          </div>
        </div>
...
// ============================================
const AutoPaySetupModalComponent = ({
  limit,
  bankAccounts,
  balances,
  onConfirm,
  ...
  const handleProceedToPin = () => {
    ...
    if (amountNum > availableAmount) {
      toast.error(
        `Amount exceeds available limit of ₹${availableAmount.toLocaleString()}`,
      );
      return;
    }
  ...
  const handleConfirmPin = async () => {
    ...
    try {
      ...
      if (currentBalance < amountNum) {
        toast.error(
          `Insufficient balance in ${selectedBank.bank_name}. Available: ₹${currentBalance.toLocaleString()}`,
        );
        setLoading(false);
        return;
      }
  ...
  return (
    <>
      <div className="modal-overlay" onClick={onCancel}>
        <div
          className="auto-pay-setup-modal-large"
          onClick={(e) => e.stopPropagation()}
        >
          ...
          <div className="modal-body auto-pay-modal-body">
            <div className="auto-pay-merchant-info">
              ...
              <div>
                ...
                <p className="available-limit">
                  Available limit: ₹{availableAmount.toLocaleString()}
                </p>
              </div>
            </div>
            ...
            <div className="form-group">
              ...
              <div className="quick-amounts">
                ...
                <button type="button" onClick={() => handleQuickAmount(5000)}>
                  ₹5,000
                </button>
                <button type="button" onClick={() => handleQuickAmount(10000)}>
                  ₹10,000
                </button>
                <button
                  type="button"
                  onClick={() => handleQuickAmount(availableAmount)}
                >
                  Max
                </button>
              </div>
                  ...
                  >
                    {availableDates.map((date) => (
                      <option key={date} value={date}>
                        {date}
                        {getOrdinalSuffix(date)} of every month
                      </option>
                    ))}
                  </select>
              ...
              <div className="form-row">
                <div className="form-group half">
                  ...
                  <p className="field-note">
                    One-time payment on selected date
                  </p>
                </div>
                <div className="form-group half">
                  <label>Time</label>
              ...
              <div className="bank-accounts-scrollable">
                {bankAccounts.length === 0 ? (
                  <div className="no-banks-warning">
                    <p>
                      ⚠️ No bank accounts linked. Please add a bank account in
                      Settings first.
                    </p>
                  </div>
                ) : (
          ...
          <div className="modal-footer">
            ...
            <button
              ...
              disabled={
                !selectedBankId || !amount || parseFloat(amount) <= 0 || loading
              }
            >
              {loading ? (
          ...
          >
            ...
            >
              ...
              <div className="modal-bank-header">
                ...
                >
                  {(() => {
                    ...
                    const bankLogo = selectedBank
                      ? getBankLogoUrl(selectedBank.bank_name)
                      : null;
                    if (bankLogo && !imageErrors[`pin_${selectedBankId}`]) {
                      return (
                        <img
                          src={bankLogo}
                          alt="bank"
                          className="bank-logo-large"
                          onError={() =>
                            setImageErrors((prev) => ({
                              ...prev,
                              [`pin_${selectedBankId}`]: true,
                            }))
                          }
                        />
                      );
              ...
              <div className="modal-actions-white">
                <button
                  className="modal-btn-white cancel"
                  onClick={() => setShowPinModal(false)}
                >
                  Cancel
                </button>
                <button
                  className="modal-btn-white submit"
...
const AutoPayCard = ({
  ...
  return (
    <div
      className={`auto-pay-card-compact ${order.status !== "active" ? "inactive" : ""}`}
    >
      <div className="auto-pay-card-header">
        ...
        <div className="auto-pay-card-info">
          ...
          <div className="schedule-type-badge">
            {getScheduleIcon()}
            <span>
              {order.schedule === "monthly"
                ? "Monthly"
                : order.schedule === "yearly"
                  ? "Yearly"
                  : "One-Time"}
            </span>
          </div>
      ...
      {order.executionHistory && order.executionHistory.length > 0 && (
        <div className="execution-history-compact">
          <span className="history-label">
            Last:{" "}
            {new Date(
              order.executionHistory[order.executionHistory.length - 1]?.date,
            ).toLocaleDateString()}
          </span>
          <span
            className={`history-status ${order.executionHistory[order.executionHistory.length - 1]?.status}`}
          >
            {order.executionHistory[order.executionHistory.length - 1]
              ?.status === "success"
              ? "✅"
              : "❌"}
          </span>
...
const ReservePayPage = () => {
  ...
  const [showDeleteAutoPayConfirm, setShowDeleteAutoPayConfirm] =
    useState(false);
  ...
  const loadAutoPayOrdersData = async () => {
    try {
      ...
      const regularOrders = updatedOrders.filter(
        (order) => !order.isBillPayment && !order.isRecharge,
      );
      const billOrders = updatedOrders.filter(
        (order) => order.isBillPayment === true,
      );
      const rechargeOrders = updatedOrders.filter(
        (order) => order.isRecharge === true,
      );
  ...
  const loadAnalytics = async () => {
    ...
    const reserveTransactions = allTransactions.filter(
      (t) =>
        t.type === "reserve_pay" ||
        t.type === "add_limit" ||
    ...
    const spendingTransactions = filtered.filter(
      (t) => t.type === "reserve_pay",
    );
    ...
    const totalAdded = filtered
      .filter((t) => t.type === "add_limit")
      .reduce((sum, t) => sum + (t.amount || 0), 0);
    const totalWithdrawn = filtered
      .filter((t) => t.type === "withdraw_limit")
      .reduce((sum, t) => sum + (t.amount || 0), 0);
    const totalAutoPay = filtered
      .filter((t) => t.type === "auto_pay_execution")
      .reduce((sum, t) => sum + (t.amount || 0), 0);
    ...
    const byCategory = Array.from(categoryMap.values())
      .map((c) => ({
        ...
        percentage: totalSpent ? (c.total / totalSpent) * 100 : 0,
      }))
    ...
    const sortedDates = Array.from(dateMap.entries()).sort(
      (a, b) => a[1].fullDate - b[1].fullDate,
    );
    const trends = sortedDates.map(([dateStr, data]) => ({
      date: dateStr,
      amount: data.amount,
  ...
  const handleAddLimitClick = () => {
    if (bankAccounts.length === 0) {
      toast.error(
        "Please add a bank account first in Settings → UPI & Bank Accounts",
      );
      return;
    }
    // Reset form first
  ...
  const validateForm = () => {
    ...
    if (formData.per_transaction_limit) {
      if (
        isNaN(formData.per_transaction_limit) ||
        formData.per_transaction_limit < 1
      ) {
        newErrors.per_transaction_limit =
          "Per transaction limit must be at least ₹1";
  ...
  const executeAddLimit = async () => {
    ...
    const {
      ...
      selectedBank: pendingBank,
    } = pendingAddData;

    try {
      // Ensure amount is a number
      const addAmount = Number(amount);
      console.log("Executing add limit:", {
        addAmount,
        pendingFormData,
        pendingBank,
      });
      ...
      if (currentBalance < addAmount) {
        toast.error(
          `Insufficient balance in ${pendingBank?.bank_name}. Available: ₹${currentBalance.toLocaleString()}`,
        );
        setLoading(false);
      ...
      await updateBankBalance(
        pendingFormData.bank_account_id,
        addAmount,
        false,
      );
      ...
      const existingLimitIndex = existingLimits.findIndex(
        (l) => l.merchant === pendingFormData.merchant,
      );
      ...
      if (existingLimitIndex !== -1) {
        ...
        const existingContributionIndex = existingContributions.findIndex(
          (c) => c.bank_account_id === pendingFormData.bank_account_id,
        );
        ...
        if (existingContributionIndex !== -1) {
          ...
          const existingContributionAmount =
            Number(updatedContributions[existingContributionIndex].amount) || 0;
        ...
        updatedLimits[existingLimitIndex] = {
          ...
          per_transaction_limit: pendingFormData.per_transaction_limit
            ? Number(pendingFormData.per_transaction_limit)
            : existingLimit.per_transaction_limit,
      ...
      try {
        ...
        // Do not leave the user's balance reduced when saving the limit fails.
        await updateBankBalance(
          pendingFormData.bank_account_id,
          addAmount,
          true,
      ...
      toast.success(
        `₹${addAmount.toLocaleString()} limit added for ${pendingFormData.merchant_name}`,
      );
    } catch (error) {
  ...
  const handleEdit = (limit) => {
    ...
    setFormData({
      ...
      per_transaction_limit: limit.per_transaction_limit
        ? limit.per_transaction_limit.toString()
        : "",
      ...
      const updatedLimits = limits.map((l) =>
        l.id === selectedLimit.id
          ? {
              ...
              per_transaction_limit: formData.per_transaction_limit
                ? parseFloat(formData.per_transaction_limit)
                : null,
  ...
  const handleWithdrawLimit = (limit) => {
    ...
    if (contributions.length === 0) {
      toast.error(
        "No bank account found for this limit. Please contact support.",
      );
      return;
    }
  ...
  const initiateWithdraw = () => {
    ...
    if (amount > availableInLimit) {
      toast.error(
        `Cannot withdraw more than ₹${availableInLimit.toLocaleString()} (unused amount)`,
      );
      return;
    }
    ...
    const bank = bankAccounts.find(
      (b) => b.id === firstContribution.bank_account_id,
    );

    if (!bank) {
      console.error("Bank not found for contribution:", firstContribution);
      toast.error(
        `Bank account not found. Available banks: ${bankAccounts.map((b) => `${b.id}:${b.bank_name}`).join(", ")}`,
      );
      return;
    }
    ...
    try {
      ...
      for (const contribution of contributions) {
        ...
        if (availableFromThisBank <= remainingToWithdraw) {
          ...
          const remainingInThisBank =
            availableFromThisBank - remainingToWithdraw;
      ...
      if (remainingToWithdraw > 0) {
        toast.error(
          `Cannot withdraw more than available. Available: ₹${(limit.monthly_limit - limit.current_spent).toLocaleString()}`,
        );
        setLoading(false);
        return;
      }
      ...
      const totalReturned = returnedToBanks.reduce(
        (sum, r) => sum + r.amount,
        0,
      );
      ...
      toast.success(
        `₹${totalReturned.toLocaleString()} withdrawn from ${limit.merchant_name}`,
      );
    } catch (error) {
    ...
    try {
      ...
      if (unusedAmount > 0 && contributions.length > 0) {
        ...
        for (const contribution of contributions) {
          ...
          console.log(
            `Returning ₹${amountToReturn} to ${contribution.bank_name} (account: ${contribution.bank_account_id})`,
          );
      ...
      const updatedLimits = currentLimits.filter(
        (l) => l.id !== selectedLimit.id,
      );
      ...
      try {
        const token = localStorage.getItem("token");
        await axios.delete(
          `http://localhost:5000/api/reserve/limits/${selectedLimit.merchant}`,
          {
            headers: token ? { Authorization: `Bearer ${token}` } : {},
          },
        );
      ...
      toast.success(
        `Limit for ${selectedLimit.merchant_name} deleted successfully`,
      );
    } catch (error) {
  ...
  const handleToggleActive = async (limit) => {
    ...
    setLimits(updated);
    toast.success(
      `${limit.merchant_name} is now ${!limit.is_active ? "active" : "inactive"}`,
    );
  };
  ...
  const getTransactionIcon = (type) => {
    switch (type) {
      case "add_limit":
        return <FaPlus className="txn-icon-add" />;
      case "withdraw_limit":
        return <FaMoneyBillWave className="txn-icon-withdraw" />;
      case "auto_pay_execution":
        return <FaClock className="txn-icon-auto" />;
      case "reserve_pay":
      case "spending":
        return <FaShoppingBag className="txn-icon-spend" />;
      default:
        return <FaExchangeAlt className="txn-icon-default" />;
    }
  };
  ...
  return (
    <div className="reserve-pay-page">
      ...
      <div className="reserve-container">
        <div className="reserve-header">
          ...
          <p className="subtitle">
            Set spending limits - No PIN required for purchases within limits!
          </p>
        </div>
              ...
              <div className="limits-grid">
                {limits.map((limit) => {
                  ...
                  const categoryColor = getCategoryColor(
                    limit.merchant_category,
                  );
                  const spentPercentage = Math.min(
                    (limit.current_spent / limit.monthly_limit) * 100,
                    100,
                  );
                  ...
                  const hasAutoPay = autoPayOrders.some(
                    (ap) => ap.limitId === limit.id && ap.status === "active",
                  );
                      ...
                      <div className="limit-card-header">
                        ...
                        <div className="merchant-info">
                          ...
                          <span className="merchant-category">
                            {merchantCategories[limit.merchant_category]
                              ?.name || limit.merchant_category}
                          </span>
                        </div>
                      ...
                      <div className="limit-card-body">
                        <div className="limit-amounts">
                          ...
                          <div className="limit-amount">
                            ...
                            <span className="limit-subvalue">
                              ₹
                              {Number(limit.monthly_limit).toLocaleString(
                                "en-IN",
                                { maximumFractionDigits: 0 },
                              )}
                            </span>
                          ...
                          {limit.per_transaction_limit && (
                            <div className="per-txn-limit">
                              ...
                              <span className="limit-subvalue">
                                ₹{limit.per_transaction_limit.toLocaleString()}
                              </span>
                            </div>
                          )}
                        </div>
                        ...
                        <div className="spent-progress">
                          <div className="progress-header">
                            ...
                            <span className="spent-amount">
                              ₹{limit.current_spent.toLocaleString()} / ₹
                              {limit.monthly_limit.toLocaleString()}
                            </span>
                          </div>
                          ...
                          <div className="limit-footer-actions">
                            {remaining > 0 && (
                              <button
                                ...
                                onClick={() => handleWithdrawLimit(limit)}
                              >
                            ...
                            {!hasAutoPay && remaining > 0 && (
                              <button
                                className="auto-pay-setup-btn"
                                onClick={() => handleSetupAutoPay(limit)}
                              >
        ...
        {activeTab === "auto-pay" && (
          ...
          >
                  ...
                  {autoPayBills.map((bill, index) => {
                    const scheduleDisplay =
                      bill.schedule === "monthly"
                        ...
                        : "One-time";
                    const nextDate = bill.nextExecution
                      ? new Date(bill.nextExecution)
                      : bill.due_date
                    ...
                    return (
                      <div
                        key={bill.bill_id || bill.id || index}
                        className="auto-pay-item"
                      >
                        <div className="auto-pay-info">
                          <div
                            className="auto-pay-icon"
                            style={{
                              background:
                                getBillCategoryColor(bill.bill_type) + "15",
                            }}
                          >
                          ...
                          <div>
                            ...
                            <p className="auto-pay-details">
                              ₹{parseFloat(bill.amount).toLocaleString()} • Due{" "}
                              {bill.due_date
                            ...
                            {bill.reserve_pay_enabled && (
                              <p className="reserve-pay-badge">
                                <img
                                  src="/images/merchants/sabailogo.png"
                                  alt="SabAI"
                                  className="assistant-icon-very-small"
                                />{" "}
                                SabAI Pay Lite
                              </p>
                            )}
                            {bill.bank_name && !bill.reserve_pay_enabled && (
                              <p className="bank-pay-badge">
                                <FaUniversity /> {bill.bank_name} (xxxx
                                {bill.bank_account_last4})
                              </p>
                            )}
                          </div>
                        </div>
            ...
            {(() => {
              ...
              const rechargeOrders = autoPayOrders.filter(
                (order) => order.isRecharge === true,
              );
                  ...
                  <div className="auto-pay-section">
                    ...
                    <div className="auto-pay-list">
                      {rechargeOrders.map((order) => {
                        ...
                        const nextDate = order.nextExecution
                          ? new Date(order.nextExecution)
                          : null;
                            ...
                            <div className="auto-pay-info">
                              ...
                              <div>
                                ...
                                {order.paymentMethod === "reserve" ? (
                                  ...
                                  <p className="bank-pay-badge">
                                    <FaUniversity /> {order.bankName} (xxxx
                                    {order.bankAccountLast4})
                                  </p>
                                )}
                              </div>
                            </div>
            ...
            {autoPayOrders.filter(
              (order) => !order.isBillPayment && !order.isRecharge,
            ).length > 0 && (
              <div className="auto-pay-section">
                <div className="section-header">
                  <h3>
                    <FaShoppingBag /> Merchant Auto-Pay
                  </h3>
                  <p className="section-note">
                    Auto-pay orders created from Set Limits
                  </p>
                </div>
            ...
            {autoPayOrders.filter(
              ...
              autoPayBills.length === 0 &&
              autoPayOrders.filter((order) => order.isRecharge === true)
                .length === 0 && (
                <div className="no-auto-pay">
                  <FaClock className="no-auto-pay-icon" />
                  <h3>No Auto Pay Orders</h3>
                  <p>
                    Set up Auto Pay for your favorite merchants, bills, or
                    mobile recharges
                  </p>
                  <button
          ...
          >
            ...
            {analyticsData.summary.totalTransactions === 0 ? (
              <div className="no-transactions-message">
                ...
                <p>
                  Start using Reserve Pay for your purchases to see analytics
                  here!
                </p>
                <button
                  className="add-limit-btn"
                  ...
                  <div className="summary-card">
                    ...
                    <div className="summary-info">
                      ...
                      <span className="summary-value">
                        ₹
                        {Math.round(
                          analyticsData.summary.totalAdded || 0,
                        ).toLocaleString()}
                      </span>
                    </div>
                  </div>
                  <div className="summary-card">
                    <div className="summary-icon withdrawn">
                      <FaMoneyBillWave />
                    </div>
                    <div className="summary-info">
                      ...
                      <span className="summary-value">
                        ₹
                        {Math.round(
                          analyticsData.summary.totalWithdrawn || 0,
                        ).toLocaleString()}
                      </span>
                    </div>
                  </div>
                  <div className="summary-card">
                    <div className="summary-icon auto">
                      <FaClock />
                    </div>
                    <div className="summary-info">
                      ...
                      <span className="summary-value">
                        ₹
                        {Math.round(
                          analyticsData.summary.totalAutoPay || 0,
                        ).toLocaleString()}
                      </span>
                    </div>
                  </div>
                      ...
                      <div key={cat.category} className="category-item">
                        <div className="category-header">
                          <span className="category-name">
                            {merchantCategories[cat.category]?.name ||
                              cat.category}
                          </span>
                        ...
                        <div className="category-stats">
                          ...
                          <span>
                            Avg: ₹{Math.round(cat.average).toLocaleString()}
                          </span>
                        </div>
                      </div>
                    ))}
                        ...
                        <div key={index} className="transaction-row">
                          ...
                          <div className="transaction-details-cell">
                            <div className="transaction-title">
                              ...
                              {txn.type === "add_limit" && (
                                <span className="txn-badge add"></span>
                              )}
                              {txn.type === "withdraw_limit" && (
                                <span className="txn-badge withdraw">
                                </span>
                              )}
                              {txn.type === "auto_pay_execution" && (
                                <span className="txn-badge auto">Auto</span>
                              )}
                              {txn.type === "reserve_pay" && (
                                <span className="txn-badge spend">Spend</span>
                              )}
                            </div>
                          ...
                          <div className="transaction-amount-cell">
                            <span
                              className={`amount ${txn.type === "add_limit" ? "positive" : txn.type === "withdraw_limit" ? "neutral" : "negative"}`}
                            >
                              {txn.type === "add_limit"
                                ? "+"
                                : txn.type === "withdraw_limit"
                                  ? "↺"
                                  : "-"}{" "}
                              ₹{Math.round(txn.amount).toLocaleString()}
                            </span>
                          </div>
                        </div>
                      ))
            ...
            >
              ...
              <div className="modal-body">
                <div className="form-group">
                    ...
                    <div className="merchant-select-wrapper">
                      <select
                        ...
                        onChange={(e) => {
                          ...
                          if (merchant) handleMerchantSelect(merchant);
                        }}
                        className={`form-select ${errors.merchant ? "error" : ""}`}
                        size="5"
                      >
                        <option value="">Choose a merchant</option>
                        {Object.keys(groupedFilteredMerchants).map(
                          (category) => (
                            <optgroup
                              key={category}
                              label={
                                merchantCategories[category]?.name || category
                              }
                            >
                              {groupedFilteredMerchants[category].map((m) => (
                  ...
                  {errors.merchant && (
                    <span className="error-text">{errors.merchant}</span>
                  )}
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        per_transaction_limit: e.target.value,
                      })
                    }
                    className={`form-input ${errors.per_transaction_limit ? "error" : ""}`}
                    min="1"
                  />
                  {errors.per_transaction_limit && (
                  ...
                  <div className="selected-bank-info">
                    <div className="bank-icon-small">
                      {(() => {
                        ...
                        const hasBankError =
                          imageErrors[`selected_bank_${selectedBank.id}`];
                          ...
                          return (
                            <img
                              ...
                              onError={() =>
                                setImageErrors((prev) => ({
                                  ...prev,
                                  [`selected_bank_${selectedBank.id}`]: true,
                                }))
                              }
                            />
                          );
              ...
              <div className="modal-footer">
                ...
                <button
                  className="btn-primary"
                  onClick={initiateAddLimit}
                  disabled={loading}
                >
                  {loading ? <FaSpinner className="spinner" /> : "Add Limit"}
                </button>
              </div>
            </motion.div>
          </motion.div>
            ...
            >
                  ...
                  selectedLimit.contributions.length > 0 && (
                    <div className="contribution-breakdown">
                      ...
                      <p className="fifo-note">
                        Withdrawals will be processed in this order (First In,
                        First Out)
                      </p>
                    </div>
                  )}
              ...
              <div className="modal-footer">
                ...
                <button
                  ...
                  disabled={loading}
                >
                  {loading ? <FaSpinner className="spinner" /> : "Update Limit"}
                </button>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <p className="warning-text">
                Unused amount will be returned to your bank account(s) in FIFO
                order.
              </p>
              <div className="confirm-actions">
                <button
                ...
                <button className="btn-danger" onClick={handleDeleteLimit}>
                  Delete
                </button>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="modal-body">
                <p className="modal-description">
                  Choose which bank account to use for this limit:
                </p>
                {bankAccounts.length === 0 ? (
                  <div className="no-banks-message">
                    <p>
                      No bank accounts linked. Please add a bank account in
                      Settings first.
                    </p>
                    <button
                      className="btn-primary"
                      onClick={() => navigate("/settings?tab=bank")}
                    >
                      Add Bank Account
                    </button>
                  </div>
                  ...
                  <div className="bank-list">
                    {bankAccounts.map((bank) => {
                      const bankLogo = getBankLogoUrl(bank.bank_name);
                      const hasBankError =
                        imageErrors[`bank_select_${bank.id}`];
                      return (
                        <div
                          key={bank.id}
                        ...
                        >
                          ...
                          <div className="bank-info">
                            ...
                            <p className="account-number">
                              xxxx{bank.account_number?.slice(-4)}
                            </p>
                            {bank.is_primary && (
            ...
            >
              ...
              <div className="modal-body">
                <p className="withdraw-info">
                  Withdraw unused amount from{" "}
                  <strong>{selectedLimit.merchant_name}</strong> limit back to
                  your bank account(s).
                </p>
                <div className="limit-info">
                  <div className="info-row">
                    ...
                    <strong>
                      ₹
                      {selectedLimit.monthly_limit.toLocaleString("en-IN", {
                        maximumFractionDigits: 0,
                      })}
                    </strong>
                  </div>
                  <div className="info-row">
                    ...
                    <strong>
                      ₹
                      {selectedLimit.current_spent.toLocaleString("en-IN", {
                        maximumFractionDigits: 0,
                      })}
                    </strong>
                  </div>
                  <div className="info-row highlight">
                    ...
                    <strong>
                      ₹
                      {(
                        selectedLimit.monthly_limit -
                        selectedLimit.current_spent
                  ...
                  selectedLimit.contributions.length > 0 && (
                    <div className="contribution-breakdown">
                      ...
                      <p className="pin-note">
                        You will verify with the PIN of the first bank in this
                        list:{" "}
                        <strong>
                          {selectedLimit.contributions[0]?.bank_name}
                        </strong>
                      </p>
                    </div>
                  )}
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    min="1"
                    max={
                      selectedLimit.monthly_limit - selectedLimit.current_spent
                    }
                  />
                </div>
              </div>
            ...
            >
              ...
              <div className="modal-bank-header">
                ...
                <div className="modal-bank-details">
                  ...
                  <p className="modal-account-white">
                    Enter UPI PIN for {selectedBank.bank_name}
                  </p>
                </div>
              </div>
      ...
      <AnimatePresence>
        {showPopUpiSuccessModal &&
          popUpiType === "limit_added" &&
          popUpiData && (
