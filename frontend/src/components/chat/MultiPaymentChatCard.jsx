...
const MultiPaymentChatCard = ({ data, onAction, onClose }) => {
  ...
  const totalAmount =
    payments?.reduce((sum, p) => sum + (p.paymentData?.amount || 0), 0) || 0;
      ...
      <div className="payment-card-body">
        ...
        <div className="multi-payment-list">
          {payments?.map((payment, index) => {
            ...
            const recipient =
              payment.paymentData?.recipient?.displayName ||
            ...
            return (
              <div key={index} className="multi-payment-item">
                ...
                <div className="item-details">
                  ...
                  {recipient && (
                    <span className="item-recipient">{recipient}</span>
                  )}
                </div>
