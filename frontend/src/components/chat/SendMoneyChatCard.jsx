...
const SendMoneyChatCard = ({ data, onAction, onClose }) => {
  ...
  const { recipient, amount, note, security, bankAccount } =
    data.paymentData || {};
  const recipientName =
    recipient?.displayName || recipient?.name || recipient?.vpa || "Recipient";
      ...
      <div className="payment-card-body">
        ...
        <div className="payment-recipient">
          ...
          <div className="recipient-info">
            ...
            {recipientVpa && (
              <span className="recipient-vpa">{recipientVpa}</span>
            )}
          </div>
        </div>
